...
ERROR_TYPE path_module_initialize(int argc, char **argv) NODISCARD;
...
ERROR_TYPE path_copy_str(struct CharBuffer *path, const char *other) NODISCARD;
ERROR_TYPE path_copy_mem(struct CharBuffer *path, const char *other, size_t other_size) NODISCARD;
...
ERROR_TYPE path_append_str(struct CharBuffer *path, const char *other) NODISCARD;
...
ERROR_TYPE path_print(struct CharBuffer *path, const char *format, ...) NODISCARD PRINTFLIKE(2, 3);
ERROR_TYPE path_vprint(struct CharBuffer *path, const char *format, va_list va) NODISCARD PRINTFLIKE(2, 0);
ERROR_TYPE path_print_append(struct CharBuffer *path, const char *format, ...) NODISCARD PRINTFLIKE(2, 3);
ERROR_TYPE path_vprint_append(struct CharBuffer *path, const char *format, va_list va) NODISCARD PRINTFLIKE(2, 0);
